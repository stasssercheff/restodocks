...
abstract final class HomeTourConfig {
  ...
  static List<({String id, String Function(LocalizationService loc) text})> ownerSteps(LocalizationService loc) => [
    ...
    (id: 'home-schedule-kitchen', text: (_) => _t(loc, 'tour_tile_schedule_dept', 'График кухни.')),
    (id: 'home-menu-kitchen', text: (_) => _t(loc, 'tour_tile_menu', 'Меню подразделения.')),
    ...
    (id: 'home-schedule-bar', text: (_) => _t(loc, 'tour_tile_schedule_dept', 'График бара.')),
    (id: 'home-menu-bar', text: (_) => _t(loc, 'tour_tile_menu', 'Меню бара.')),
    (id: 'home-ttk-bar', text: (_) => _t(loc, 'tour_tile_ttk', 'ТТК бара.')),
    (id: 'home-nomenclature-bar', text: (_) => _t(loc, 'tour_tile_nomenclature', 'Номенклатура бара.')),
    (id: 'home-suppliers-bar', text: (_) => _t(loc, 'tour_tile_suppliers', 'Поставщики бара.')),
    (id: 'home-order-bar', text: (_) => _t(loc, 'tour_tile_order', 'Заказ продуктов (бар).')),
    (id: 'home-writeoffs-bar', text: (_) => _t(loc, 'tour_tile_writeoffs', 'Списания (бар).')),
    (id: 'home-checklists-bar', text: (_) => _t(loc, 'tour_tile_checklists', 'Чеклисты (бар).')),
    (id: 'home-schedule-hall', text: (_) => _t(loc, 'tour_tile_schedule_dept', 'График зала.')),
    (id: 'home-menu-hall', text: (_) => _t(loc, 'tour_tile_menu', 'Меню зала.')),
    (id: 'home-checklists-hall', text: (_) => _t(loc, 'tour_tile_checklists', 'Чеклисты (зал).')),
    (id: 'home-suppliers-hall', text: (_) => _t(loc, 'tour_tile_suppliers', 'Поставщики (зал).')),
    (id: 'home-order-hall', text: (_) => _t(loc, 'tour_tile_order', 'Заказ продуктов (зал).')),
    (id: 'home-writeoffs-hall', text: (_) => _t(loc, 'tour_tile_writeoffs', 'Списания (зал).')),
