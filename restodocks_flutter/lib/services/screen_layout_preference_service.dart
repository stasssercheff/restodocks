...
/// Настройки экрана: показ «Банкет/Кейтринг», оповещение о ДР (0 = выкл, 1–5 дней, время HH:mm).
class ScreenLayoutPreferenceService extends ChangeNotifier {
  static final ScreenLayoutPreferenceService _instance =
