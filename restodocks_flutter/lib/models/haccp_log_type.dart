...
/// Типы журналов автоконтроля (в РФ исторически — «по СанПиН»).
/// Названия и нормативные ссылки в интерфейсе — из `localizable.json` (для `es` — APPCC / 852/2004, RD 191/2011).
/// Остальные значения enum оставлены для совместимости с БД при миграции.
enum HaccpLogType {
