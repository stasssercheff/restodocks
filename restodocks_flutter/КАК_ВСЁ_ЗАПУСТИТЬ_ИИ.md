...
| **GOOGLE_TRANSLATE_API_KEY** | Ключ из [Google Cloud Console](https://console.cloud.google.com) (APIs → Cloud Translation API → Credentials → Create API key) | Переводы продуктов и ТТК. Без него — MyMemory (ограниченный лимит). |
