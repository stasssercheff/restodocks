...
-- 1) Сначала выполнить scripts/link_employees_to_auth_users.sql для существующих.
-- 2) Эта миграция обновит RPC create_owner_employee, complete_pending_owner_registration,
--    create_employee_for_company, create_co_owner_from_invitation — auth_user_id будет проставляться.

-- 1. create_owner_employee
