-- Выполните этот SQL в Supabase Dashboard → SQL Editor, если миграции не применяются автоматически.
-- Сохраняет график смен и списки поставщиков в Supabase (не теряются при редеплое).
