...
DROP POLICY IF EXISTS "authenticated_select_tt_parse_corrections" ON tt_parse_corrections;
CREATE POLICY "authenticated_select_tt_parse_corrections" ON tt_parse_corrections
  FOR SELECT TO authenticated USING (true);

DROP POLICY IF EXISTS "authenticated_insert_tt_parse_corrections" ON tt_parse_corrections;
