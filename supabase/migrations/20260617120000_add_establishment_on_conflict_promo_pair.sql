-- После 20260616120000 снят UNIQUE(establishment_id) с promo_code_redemptions — ON CONFLICT (establishment_id) недопустим.
-- Копирование промо на новый филиал: конфликт по паре (promo_code_id, establishment_id) (ограничение из 20260331140000).
