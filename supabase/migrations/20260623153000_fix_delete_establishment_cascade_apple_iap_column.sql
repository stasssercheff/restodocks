-- Fix admin/owner establishment deletion when apple_iap_subscription_claims
-- already migrated from establishment_id to owner_id.
...
BEGIN
  ...
  IF EXISTS (
    ...
    WHERE table_schema = 'public'
      AND table_name = 'apple_iap_subscription_claims'
