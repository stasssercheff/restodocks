-- Восстановление колонок ui_theme / ui_view_as_owner в RPC после 20260430261000
-- (иначе AccountUiSyncService пишет в p_patch, а UPDATE их не трогает — лишние вызовы и путаница).
